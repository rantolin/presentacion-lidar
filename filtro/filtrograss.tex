...
%%==================================================================F 
\begin{frame}
  \frametitle{Conexión a internet}
 \begin{center}
   \includegraphics[height=50mm]{images/internet}
 \end{center}
\end{frame}
%%==================================================================F 
...
\begin{lstlisting}[style=shell]
  ...
  $ python isprs2lf.py CSite4_orig.txt_orig.txt
...
GRASS6: > r.in.xyz -sg in=CSite4_orig.txt
...
r.in.xyz in=CSite4_orig.txt out=stuttgart_first fs='|' x=1 y=2 z=3
r.in.xyz in=CSite4_orig.txt out=stuttgart_last fs='|' x=4 y=5 z=6
\end{lstlisting}
}
\begin{frame}
...
v.in.ascii -tbzr in=CSite4_orig.txt out=stuttgart_first fs='|' x=1 y=2 z=3
v.in.ascii -tbzr in=CSite4_orig.txt out=stuttgart_last fs='|' x=4 y=5 z=6
\end{lstlisting}
}
\begin{frame}
